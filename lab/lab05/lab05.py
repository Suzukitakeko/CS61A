...
def sprout_leaves(t, leaves):
    ...
    if is_leaf(t):
        ...
        return tree(label(t), [sprout_leaves(tree, leaves) for tree in branches(t)])
...
def riffle(deck):
    ...
    """
    "*** YOUR CODE HERE ***"
    return [deck[len(deck) // 2 + i // 2] if (i % 2) == 1 else deck[i // 2] for i in range(len(deck))]
