...
class CallExpr(Expr):
    ...
    def eval(self, env):
        ...
        Number(14)
        """
        arguments = [obj.eval(env) for obj in self.operands]
...
class LambdaFunction(Value):
    ...
    def apply(self, arguments):
        ...
        # arguments = [obj.value for obj in arguments]
        present_env = self.parent.copy()
        present_env.update(dict(zip(self.parameters, arguments)))
        return self.body.eval(present_env)
