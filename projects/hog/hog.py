...
def swine_align(player_score, opponent_score):
    ...
    def gcd(a,b):
        ...
        if b == 0:
            ...
            return gcd(b, a%b)
    c = gcd(player_score, opponent_score)
    if c < 10:
        return False
    else:
        return True
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def announce1(score0, score1):
        difference = score1 - last_score
        last_score_now = score1
        running_high_now = running_high
        if difference > running_high:
            running_high_now = difference
        
            print(running_high_now, 'point(s)! The most yet for Player 1')
        return announce_highest(1, last_score_now, running_high_now)
    
    def announce0(score0, score1):
        difference = score0 - last_score
        last_score_now = score0
        running_high_now = running_high
        if difference > running_high:
            running_high_now = difference
            
            print(running_high_now, 'point(s)! The most yet for Player 0')
        return announce_highest(0, last_score_now, running_high_now)
